<div
    ...
    <style>
        .color-boton {
            background-color: rgb(68, 40, 248)
        }
    </style>
    {{-- Menú de navegación --}}
    <div class="container w-full flex justify-center gap-4 mt-4 py-10">
        <nav>
            <div class="flex flex-col gap-2 md:flex-row md:gap-4">
                <a href="{{ route('dashboard') }}" class="text-white font-bold">
                    <button class="rounded-md color-boton text-white p-2">{{ __('Dashboard') }}</button>
                </a>

                <a href="{{ route('picks') }}" class="text-white font-bold">
                    <button class="rounded-md color-boton text-white p-2">{{ __('Picks') }}</button>
                </a>

                <a href="{{ route('table-picks') }}">
                    <button class="rounded-md color-boton text-white p-2">{{ __('Picks Table') }}</button>
                </a>

                <a href="{{ route('positions-by-round') }}">
                    <button class="rounded-md color-boton text-white p-2">{{ __('Round Positions') }}</button>
                </a>

                <a href="{{ route('user-survivors') }}">
                    <button class="rounded-md color-boton text-white p-2">{{ __('Survivors') }}</button>
                </a>

                <a href="{{ route('table-survivors') }}">
                    <button class="rounded-md color-boton text-white p-2">{{ __('Table Survivors') }}</button>
                </a>

                <a href="{{ route('position-general') }}">
                    <button class="rounded-md color-boton text-white p-2">{{ __('General Positions') }}</button>
                </a>
