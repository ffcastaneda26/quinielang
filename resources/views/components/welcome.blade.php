...
<div class="p-6 lg:p-8 bg-white text-black">
    ...
    <div class="bg-gray-100 text-black grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
        ...
        <div>
            ...
            <div>
                <ul class="list-disc">
                    <li>En la sección de "Pronósticos" Cada Participante selecciona entre Local y Visita pronosticando
                        al Ganador.</li>
                    <li>En el último partido de cada Jornada se debe pronosticar Puntos Local y Puntos Visita, este es
                        el Partido Desempate y los criterios se listan en la sección de desempate.</li>
                    <li>La Selección de Local/Visita del Partido Desempate cambia automáticamente después de modificar
                        los puntos local o visita.</li>
                    <li>Cada pronóstico puede ser modificado hasta 5 minutos antes de la hora de inicio del partido.
                    </li>
        ...
        <div>
            ...
            <ul>
                ...
                <li>2. Más Puntos en los partidos de desempate (El SB Vale sencillo).</li>
        ...
        <div>
            ...
            <ul class="list-disc">
                ...
                <li>En caso de seguir empates tras aplicar los criterios, las bolsas de las posiciones empatadas se
                    repartirán entre el número de participantes empatados.</li>
        ...
        <div>
            ...
            <ul class="list-disc">
                <li>
                    En la sección de <strong>"Survivor"</strong> cada Partitipante seleccionará un equipo por Jornada
                    (No se puede repetir equipo en toda la Temporada Regular).
                </li>
                <li>Si tu equipo seleccionado gana, "sobrevives" la Jornada y continuas con vida para la siguiente
                    jornada.</li>
                <li>Si tu equipo seleccionado empata o pierde quedas eliminado del premio Survivor y continuas
                    participando como Zombie.</li>
                <li>Si no hiciste selección en la Jornada o duplicaste un equipo entonces quedas eliminado del premio
                    Survivor y continuas participando como Zombie.</li>
                <li>Cada Jornada los equipos estarán disponibles para selección cuando se cumplan los siguientes
                    requisitos:</li>
            ...
            <div class="flex items-center">
                <p class="mt-4 ml-50 font-bold italic">
                    *Los pronósticos survivor de cada Jornada se hacen simultaneamente visibles y no editables para
                    todos los participantes 5 minutos ante de iniciar el primer partido de la Jornada en donde algún
                    participante tenga equipo seleccionado.
                </p>
            </div>
        ...
        <div>
            ...
            <ul class="list-disc">
                <li>a) Ganador Survivor Único, si al término de una Jornada existe un sólo sobreviviente, éste declara
                    ganador Survivor y el resto participan por el premio de Zombies (2do Lugar).</li>
                <li>b) Sin Ganador Survivor, si al término de una Jornada no hay sobrevivente todos los participantes
                    compiten como Zombies. (Esto sucede cuando la jornada inicia con 2+ Sobrevivientes y termina sin
                    sobrevivientes)</li>
                <li>c) Ganadores Multi Survivor, si al término de la Temporada Regular hay 2+ Sobrevivientes estos serán
                    ganadores, el desempate se juega en playoffs, de suceder los 2 premios serían a Surviors y no hay
                    premiación de Zombies.</li>
            ...
            <ul class="list-disc">
                <li>Zombies son los participantes eliminados del Survivor, estos seguirán participando por el resto de
                    la temporada a la espera de que no haya Survivors Múltiples para obtener premio.</li>
                <li>
                    Cada Jornada donde se acierta Ganador es un punto, el Zombie con más puntos en toda la temporada
                    Regular será el ganador, en caso de empate se jugará un torneo Survivor en Playoffs y de seguir
                    empatados aplican los siguientes criterios:
                </li>
                <div class="flex justify-end">
                    <ul style="list-style-type:decimal" class="mt-2">
